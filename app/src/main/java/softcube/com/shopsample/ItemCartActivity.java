...
public class ItemCartActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.item_cart_content);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(ItemCartActivity.this, ShopingCartActivity.class);
    ...
    protected void onStart() {
        super.onStart();
        softCubeClient.pageView("ProductsListPage");
    }
}
